...
set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS33 } [get_ports { BTN_D }]; #IO_L22N_T3_16 Sch=btnd
#set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS33 } [get_ports { btnl }]; #IO_L20P_T3_16 Sch=btnl
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports { BTN_R }]; #IO_L6P_T0_16 Sch=btnr
