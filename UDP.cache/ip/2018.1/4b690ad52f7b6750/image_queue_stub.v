...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ image_queue_stub.v
// Design      : image_queue
...
/* synthesis syn_black_box black_box_pad_pin="clk,srst,din[7:0],wr_en,rd_en,dout[7:0],full,overflow,empty,valid,underflow,data_count[13:0]" */;
  input clk;
  input srst;
  input [7:0]din;
  input wr_en;
