...
HD_PWD='/home/moikawa/proj_Mitsuhashi/NexysVideo_UdpTest/UDP.runs/queue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log queue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source queue.tcl
